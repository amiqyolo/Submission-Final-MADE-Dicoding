...
package com.aplen.core.databinding;
...
public final class ItemRowMovieBinding implements ViewBinding {
  @NonNull
  ...
  private ItemRowMovieBinding(@NonNull MaterialCardView rootView, @NonNull ImageView imgItemPoster,
      @NonNull MaterialCardView mcvPoster, @NonNull TextView tvItemOverview,
      @NonNull TextView tvItemRating, @NonNull TextView tvItemTitle) {
  ...
  @NonNull
  public static ItemRowMovieBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRowMovieBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_row_movie, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRowMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRowMovieBinding((MaterialCardView) rootView, imgItemPoster, mcvPoster,
